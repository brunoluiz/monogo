...
type WithDiffOption func(*diffConfig)

func WithPath(path string) func(*diffConfig) {
...
func Diff(compareRef string, opts ...WithDiffOption) ([]string, error) {
	cfg := diffConfig{
		path: ".",
	}
	...
	sourceRef, err := r.ResolveRevision(plumbing.Revision(compareRef))
	if err != nil {
